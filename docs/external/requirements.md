...
- Rust backend quality gate は `.github/workflows/ci.yml` の `rust-quality` job と `specs/019-rust-quality-ci/` を正本とし、no-op/full path gating と segment artifact を維持する
